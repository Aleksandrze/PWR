...
def zad2(fun:(Double=>Double),dx:Double,list:List[Double]):List[Double] = {
  ...
  temp(list,Nil)
}                                                 //> zad2: (fun: Double => Double, dx: Double, list: List[Double])List[Double]


zad2(math.sin,1.0E-10,List(0,0.5,1.5,2,4))        //> res2: List[Double] = List(1.0, 0.8775824511531027, 0.07073674979096722, -0.
                                                  //| 4161471167662967, -0.6536438057480609)
